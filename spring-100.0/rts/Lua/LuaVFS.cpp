...
int LuaVFS::BuildPPEditor(lua_State* L) {
	...
	const string editorName = "games/SPRED for " + game + ".sdz";
	
	// Locate launcher zip
	const string launcherPath = dataDirsAccess.LocateFile("games/SPRED.sdz");
...
int LuaVFS::BuildPPGame(lua_State* L) {
	...
	const string gameFileName = "games/" + gameName + ".sdz";
